...
| Manifesto de FKs | JSON estático alinhado a [Banco laboratorial](../04-arquitetura-dados/banco-laboratorio-dominio.md). |
...
- Testes de contrato MCP: validam payloads contra [Contratos MCP v1](../07-contratos-mcp/contracts-v1.md).
