...
!!! info "Recomendado para leitura prévia"
    - **[Runbook de reprodutibilidade](../experimento/runbook-reprodutibilidade.md)** — passos para repetir uma corrida com evidências.
    - **[Protocolo de avaliação](../experimento/protocolo-avaliacao.md)** — desenho experimental, bateria e critérios de desfecho.
    - **[Cluster Hadoop](../infraestrutura/cluster-hadoop.md)** — serviços ODP, sizing e operação.
...
Convenções e exigências mínimas estão em [Evidências experimentais](../evidence/README.md) e [Runbook de reprodutibilidade](../experimento/runbook-reprodutibilidade.md).
...
!!! tip "Recomendado para leitura posterior"
    Seguinte: **[Rastreabilidade acadêmica](../pesquisa/rastreabilidade-academica.md)** — relação com a documentação acadêmica externa.
