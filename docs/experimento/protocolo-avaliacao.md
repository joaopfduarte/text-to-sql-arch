...
!!! info "Recomendado para leitura prévia"
    - **[Produto e escopo](../produto/escopo.md)** — definição de erro estrutural.
    - **[Schema massa de teste](../arquitetura/dados/schema-massa-teste.md)** — inventário das 92 entidades.
...
- O catálogo MCP expõe **quinze tools** de descoberta (ver [Contratos MCP v1](../arquitetura/contratos-mcp/contracts-v1.md)). A avaliação MVP prioriza as três basais (`catalog.listTables`, `catalog.describeTable`, `catalog.listRelationships`); as doze complementares ficam disponíveis sob o mesmo orçamento.
