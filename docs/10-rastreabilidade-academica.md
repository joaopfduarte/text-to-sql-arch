...
| [`04-arquitetura-dados/banco-putz-dominio.md`](04-arquitetura-dados/banco-putz-dominio.md) | [`content/cap4-metodologia.tex`](../../content/cap4-metodologia.tex) (banco de testes) | Domínios e tabelas-âncora do PS. |
| [`04-arquitetura-dados/schema-massa-teste.md`](04-arquitetura-dados/schema-massa-teste.md) | [`content/cap4-metodologia.tex`](../../content/cap4-metodologia.tex) (massa de teste) | Subconjunto fixo. |
...
| [`08-experimento-avaliacao/llm-inferencia-e-prompts.md`](08-experimento-avaliacao/llm-inferencia-e-prompts.md) | [`content/cap4-metodologia.tex`](../../content/cap4-metodologia.tex) (§ Registro Experimental) | Hiperparâmetros LLM, prompts e `context.json`. |
...
| [`../adr/ADR-0003-inferencia-llm-deterministica.md`](../adr/ADR-0003-inferencia-llm-deterministica.md) | [`content/cap4-metodologia.tex`](../../content/cap4-metodologia.tex) (§ Registro Experimental) | Política `temperature=0` e paridade de prompts. |
