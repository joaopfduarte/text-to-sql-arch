...
!!! info "Recomendado para leitura prévia"
    - **[Arquitetura de negócio](../negocio.md)** — atores, blocos e contratos macro.
...
Fonte: [Diagrama de rede lógica](../../diagrams/rede-implantacao.svg). Para a tradução física para AWS, ver [Visão AWS](../../infraestrutura/visao-aws.md).
