...
Um pipeline Text-to-SQL onde o agente LLM **consulta metadados de catálogo via MCP antes de gerar SQL**. O objetivo é medir aderência estrutural, executabilidade e rastreabilidade contra um banco real (subconjunto Putz) em cluster AWS mínimo.
...
| 3 | [`../diagrams/diagrama-mestre.mmd`](../diagrams/diagrama-mestre.mmd) — fluxo lógico ponta a ponta | 2 min |
...
| 8 | [`../diagrams/cluster-topologia-aws.mmd`](../diagrams/cluster-topologia-aws.mmd) — diagrama de deployment | 3 min |
...
| Pessoa que governa decisões | [`../adr/`](../adr/) (ADR-0001 e ADR-0002) |
...
| Putz | Banco relacional real cujo subconjunto congelado é a massa de avaliação. |
