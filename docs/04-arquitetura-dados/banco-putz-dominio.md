# Banco de domínio Putz

## Propósito

Resumo operacional do schema relacional do Putz, identificando domínios, tabelas-âncora e FKs relevantes para o pipeline Text-to-SQL e para a carga no cluster.
...
| Conta e segurança | `putz_user`, `putz_authority`, `putz_user_authority`, `putz_persistent_audit_event`, `putz_persistent_audit_evt_data` | Não selecionado no MVP (PII potencial). |
