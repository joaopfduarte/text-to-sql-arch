...
|-------------------|------------------------------|----------|
| [Produto e escopo](../produto/escopo.md) | Introdução | Objetivo, escopo, erro estrutural |
| [Arquitetura de negócio](../arquitetura/negocio.md) | Introdução / metodologia | Blocos e contratos macro |
| [Visão lógica](../arquitetura/aplicacao/visao-logica.md) | Metodologia | Camadas, MCP, fluxo |
