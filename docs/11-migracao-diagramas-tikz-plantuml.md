...
|---|---|---|
| `cap1-fluxo-logico.pdf` | `assets/figures/code/mmd/cap1-fluxo-logico.mmd` | `documentacao-academica-externa/cap1-introducao.tex`, `apresentacao/sections/02-pergunta-objetivos.tex` |
| `cap4-ingestao-massa.pdf` | `assets/figures/code/tikz/cap4-ingestao-massa.tikz.tex` | `documentacao-academica-externa/cap4-metodologia.tex`, `apresentacao/sections/04-metodologia.tex` |
| `cap4-fluxo-artefato.pdf` | `assets/figures/code/tikz/cap4-fluxo-artefato.tikz.tex` | `documentacao-academica-externa/cap4-metodologia.tex`, `apresentacao/sections/04-metodologia.tex` |
