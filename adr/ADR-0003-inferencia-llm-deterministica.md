...
7. Documentação canónica: [`../docs/08-experimento-avaliacao/llm-inferencia-e-prompts.md`](../docs/08-experimento-avaliacao/llm-inferencia-e-prompts.md).
...
- [`llm-inferencia-e-prompts.md`](../docs/08-experimento-avaliacao/llm-inferencia-e-prompts.md)
