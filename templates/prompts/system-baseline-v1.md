...
1. O esquema relacional **`base_laboratorial`** (92 tabelas) é fornecido **integralmente** via DDL anexo na
   mensagem do usuário ([Dump MySQL base_laboratorial](../../dados/base_laboratorial.sql);
   inventário em [Schema massa de teste](../../arquitetura/dados/schema-massa-teste.md)).
